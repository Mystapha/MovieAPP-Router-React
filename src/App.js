...
function App() {
  const [movies, setmovies] = useState([
    ...
    {id:Math.random(),
      name: "The Circle",
      posterurl:
        "https://www.abc-luxe.com/wp-content/uploads/2017/08/The-Circle-The-movie.jpg",
      description:
  ...
  return (
    <div className="App">
      ...
      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/iM150ZWovZM?si=cWJbbCb_Nn9PGSg_&autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      <div className='continue'>
    <Navbara settext={settext} setrate={setrate}/>
