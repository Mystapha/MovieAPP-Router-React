      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
            <Nav.Link style={{color:"white",fontWeight:"500", fontSize:"20px",fontFamily:"Popines"}} href="#action1"><Link style={{textDecoration:"none",color:"white"}} to="/">Movies</Link></Nav.Link>
            <Nav.Link style={{color:"white",fontWeight:"500", fontSize:"20px",fontFamily:"Popines"}} href="#action2"><Link style={{textDecoration:"none",color:"white"}} to="/contact">Conatct</Link></Nav.Link>
